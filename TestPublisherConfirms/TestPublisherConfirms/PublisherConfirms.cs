...
class PublisherConfirms
{
    ...
    private static void PublishMessagesIndividually()
    {
        ...
        using (var channel = connection.CreateModel())
        {
            ...
            for (int i = 0; i < MESSAGE_COUNT; i++)
            {
                ...
                //aqui conseguimos uma confirmação por cada mensagem
    ...
    private static void PublishMessagesInBatch()
    {
        ...
        using (var channel = connection.CreateModel())
        {
            ...
            for (int i = 0; i < MESSAGE_COUNT; i++)
            {
                ...
                {
                    //aqui conseguimos uma confirmação de grupos de mensagens
                    channel.WaitForConfirmsOrDie(new TimeSpan(0, 0, 5));
    ...
    private static void HandlePublishConfirmsAsynchronously()
    {
        ...
        {
            //aqui são arquivados as mensagens que foram confirmadas

            //se multiple for true uma ou mais mensagem foram confirmadas
            //se multipe for false uma unica mensagem foi confirmada
            if (multiple)
            {
        ...
        {
            //aqui serão mensagens sem confirmação
